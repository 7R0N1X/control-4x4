...
export const FormButton = ({ type, text }: FormButtonProps) => {
  return type === "internal" ? (
    ...
    <button className="flex w-full cursor-pointer items-center justify-center gap-2.5 rounded-md bg-[#FFFFFF] px-4 py-2 text-base font-medium text-[#9394A5] ring ring-[#9394A5] transition-colors duration-300 hover:bg-[#FAFAFA]">

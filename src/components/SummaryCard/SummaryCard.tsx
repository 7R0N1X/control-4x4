  ...
  return (
    <div className="w-full rounded-[8px] border border-[#E4E4E7] bg-white p-6 shadow-sm">
      <div className="space-y-2">
        <p className="flex items-center gap-2.5 font-medium text-[#52525B]">
        ...
        <p
          className={`text-xl font-bold ${title == "Total Importación" && "text-[#18181B]"} ${title == "Saldo de Cupo" && "text-[#4ADE80]"} ${title == "Cupo Anual" && "text-[#D4AF37]"}`}
        >
          ${amount}
        </p>
      </div>
